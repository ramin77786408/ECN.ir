...
class ProductsPage{
    ...
    setFiltersFromURL(){
        ...
        const searchQuery = Util.getParameterByName('q') || undefined;
    ...
    handlePagination() {
        ...
        $(document).on('click','.pagination a ',function (event) {
            ...
            const nextPage = Number(self.filters.page) + 1;
            self.filters.page = Number(self.filters.page) + 1;
            Url.updateSearchParam('page',nextPage);
            self.getProductsAjaxAndUpdateUI();
        })
    }
